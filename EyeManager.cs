...
public class EyeManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Return))
        {
            ...
            Camera.main.transform.position = new Vector3(rightCameraPosition[0], rightCameraPosition[1], rightCameraPosition[2]);
            Camera.main.transform.rotation = Quaternion.Euler(new Vector3(rightCameraRotation[0], rightCameraRotation[1], rightCameraRotation[2]));
        }
